        ...
        <section className="w-[80%] mx-auto py-16 grid md:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <div className="space-y-3 text-gray-800 text-sm">
                    <p><strong>Adres:</strong> Kavaklıönü, Atatürk Blv. No:61, 50400 Ürgüp/Nevşehir</p>
                    <p><strong>Eposta:</strong> info@yildizhotel.com</p>
                    <p><strong>Telefon:</strong> 0 (384) 341 46 10</p>
                    <p><strong>Whatsapp:</strong> +90 530 389 71 63</p>
                </div>
            </div>
